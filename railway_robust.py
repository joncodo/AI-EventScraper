#!/usr/bin/env python3
"""
Railway-Robust Server with Bulletproof Database Handling

This version is specifically designed for Railway deployment with:
1. Bulletproof database connection handling
2. Proper MongoDB boolean checks
