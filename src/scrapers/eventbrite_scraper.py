"""Eventbrite scraper for the AI Event Scraper."""
import asyncio
import json
import logging
...
class EventbriteScraper(BaseScraper):
    ...
    async def scrape_events(
        ...
        try:
            ...
            search_url = "https://www.eventbrite.com/d/search"
    ...
    async def _parse_event_card(self, card, city: str, country: str) -> Optional[Event]:
        ...
        try:
            ...
            title_element = card.find('h2', class_='event-title')
            ...
            # Extract price
            price_element = card.find('div', class_='event-price')
            price = None
            currency = None
            if price_element:
    ...
    async def get_event_details(self, event_url: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error getting Eventbrite event details: {e}")
            return None
